...
You can declare that file name as a constant at the top of main.cpp (file that has the routine main(), or it can be in main().
...
processing - high level processing steps
