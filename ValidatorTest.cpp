 ...
 * @brief Unit Test for Validator.h
 * @version 0.1
 * @date 29-2-2024
 *
 */
...
int main ()
{
    ...
    cout << " Negative case, not leap year (29/2/2022): " << validate.IsValidDate(29,2,2022) << endl;
    cout << endl;
    ...
    cout << " Negative case, wrong year (2/99):     " << validate.IsValidDate(2,99) << endl;
    cout << endl;
    ...
    cout << " Negative case (2022): " << validate.IsLeapYear(2022) << endl;
    cout << endl;
    ...
    cout << " Negative case, wrong minute (24,60): " << validate.IsValid24HourTime(24,6) << endl;
    cout << endl;
    ...
    cout << " Negative case, octal numbers (08):    " << validate.IsNumber("08") << endl;
    cout << endl;
    ...
    cout << " Negative case (08):    " << validate.IsInteger("08") << endl;
